...
\begin{document}
	...
	\begin{itemize}[noitemsep, topsep=0pt]
		...
		\begin{enumerate}[label*=\arabic*., noitemsep]
			\item \textbf{Amaral, AVR}, Wolffram, D, Moraga, P, and Bracher, J (2024+). \textit{Data-driven post-processing and ensembling of infectious disease nowcasts}. In preparation.
		\end{enumerate}
	\end{itemize}
	\vspace{-2pt}
