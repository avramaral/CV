...
\begin{document}
	...
	\begin{enumerate}[noitemsep, topsep=0pt]
		\item \textbf{Post-doctoral Researcher Associate in Mathematics} at \textit{Imperial College London}. London, England. From 01/2024 to CURRENT.
	\end{enumerate}
	...
	\begin{itemize}[noitemsep, topsep=0pt]
		...
		%\begin{enumerate}[label*=\arabic*., noitemsep]
		%	\item \textbf{Amaral, AVR}, Wolffram, D, Moraga, P, and Bracher, J (2023+). \textit{Data-driven post-processing and ensembling of infectious disease nowcasts}. In preparation.
		%\end{enumerate}
	\end{itemize}
	\vspace{-2pt}
