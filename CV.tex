...
\begin{document}
	...
	\begin{itemize}[noitemsep, topsep=0pt]
		...
		% \item  Zhong, R, \textbf{Amaral, AVR}, and Moraga, P (2024).\textit{ Spatial data fusion adjusting for preferential sampling using INLA and SPDE}. Royal Statistical Society (Series A). \href{https://doi.org/10.1093/jrsssa/qnae058}{\url{https://doi.org/10.1093/jrsssa/qnae058}}.
